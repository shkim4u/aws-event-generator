 ...
 */
package com.aws.proserve.korea.network.syslog.utils;
...
import com.aws.proserve.korea.network.syslog.integration.jul.util.LevelHelper;
...
public class InternalLogger {
    ...
    static {
        try {
            level = LevelHelper.findLevel(System.getProperty("com.microfocus.security.arcsight.network.syslog.debugLevel"));

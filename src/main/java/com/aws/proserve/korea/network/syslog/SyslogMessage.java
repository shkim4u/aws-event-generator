 ...
 */
package com.aws.proserve.korea.network.syslog;
...
import com.aws.proserve.korea.network.syslog.utils.ConcurrentDateFormat;

/**
 * Syslog message as defined in
 * <a href="https://tools.ietf.org/html/rfc5424">RFC 5424 - The Syslog
 * Protocol</a>.
 *
 * Also compatible with <a href="http://tools.ietf.org/html/rfc3164">RFC-3164:
 * The BSD syslog Protocol</a>,
 *
...
public class SyslogMessage {
	...
	private static CachingReference<String> localhostNameReference = new CachingReference<String>(10,
		TimeUnit.SECONDS) {
		@Override
	...
	static {
		int concurrency;
		try {
			concurrency = Integer.parseInt(System.getProperty(
				SyslogMessage.class.getPackage().getName() + ".concurrency", String.valueOf(DEFAULT_CONCURRENCY)));
		} catch (Exception e) {
			concurrency = DEFAULT_CONCURRENCY;
		}

		rfc3339DateFormat = new ConcurrentDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", Locale.US,
			TimeZone.getTimeZone("GMT"), concurrency);

		/**
		 * According to
		 * <a href="http://tools.ietf.org/html/rfc3164#section-4.1.2">RFC31614- 4.1.2
		 * HEADER Part of a syslog Packet</a>, we should use local time and not GMT.
		 * <quote> The TIMESTAMP field is the local time and is in the format of "Mmm dd
		 * hh:mm:ss" (without the quote marks) </quote>
		 */
	...
	/**
	 * Use a {@link java.io.CharArrayWriter} instead of a {@link String} or a
	 * {@code char[]} because middlewares like Apache Tomcat use
	 * {@code CharArrayWriter} and it's convenient for pooling objects.
	 */
	private CharArrayWriter msg;

	private boolean prependPRIPart = true;
	private boolean prependHeaderTimestamp = false;
	private boolean prependHeaderHostname = false;
	private boolean prependHeaderAppName = false;
	...
	public SyslogMessage withPrependPRIPart(boolean syslogPrependPRIPart) {
		this.prependPRIPart = syslogPrependPRIPart;
		return this;
	}

	public SyslogMessage withPrependHeaderTimestamp(boolean syslogPrependHeaderTimestamp) {
		this.prependHeaderTimestamp = syslogPrependHeaderTimestamp;
		return this;
	}

	public SyslogMessage withPrependHeaderHostname(boolean syslogPrependHeaderHostname) {
		this.prependHeaderHostname = syslogPrependHeaderHostname;
		return this;
	}

	public SyslogMessage withPrependHeaderAppName(boolean syslogPrependHeaderAppName) {
		this.prependHeaderAppName = syslogPrependHeaderAppName;
		return this;
	}
	...
	/**
	 * Generates a Syslog message complying to the
	 * <a href="http://tools.ietf.org/html/rfc5424">RFC-5424</a> format or to the
	 * <a href="http://tools.ietf.org/html/rfc3164">RFC-3164</a> format.
	 *
	 * @param messageFormat
	 *            message format, not {@code null}
	 */
	...
	/**
	 * Generates an <a href="http://tools.ietf.org/html/rfc5424">RFC-5425</a>
	 * message.
	 */
	...
	/**
	 * Generates an <a href="http://tools.ietf.org/html/rfc5425">RFC-5425</a>
	 * message.
	 */
	...
	/**
	 * Generates an <a href="http://tools.ietf.org/html/rfc5424">RFC-5424</a>
	 * message.
	 */
	 ...
	 * <a href="https://tools.ietf.org/html/rfc5424#section-6.2.1">RFC-5424, Section
	 * 6.2.1</a>
	 */
	public void toRfc5424SyslogMessage(Writer out) throws IOException {

		// [2018-10-25] Kim, Sang Hyoun: Customized PRI and Header parts.
		if (this.prependPRIPart) {
	...
	/**
	 * Generates an <a href="http://tools.ietf.org/html/rfc3164">RFC-3164</a>
	 * message.
	 *
	...
	public void toRfc3164SyslogMessage(Writer out) throws IOException {
		...
		if (msg != null) {
			if (prependHeaderTimestamp | prependHeaderHostname | prependHeaderAppName) {
				out.write(": ");
			}
			msg.writeTo(out);
		}
	...
	protected void writeStructuredDataOrNillableValue(Set<SDElement> ssde, Writer out)
		throws IOException {
	...
	public boolean isPrependPRIPart() {
		return prependPRIPart;
	}

	public void setPrependPRIPart(boolean prependPRIPart) {
		this.prependPRIPart = prependPRIPart;
	}

	public boolean isPrependHeaderTimestamp() {
		return prependHeaderTimestamp;
	}

	public void setPrependHeaderTimestamp(boolean prependHeaderTimestamp) {
		this.prependHeaderTimestamp = prependHeaderTimestamp;
	}

	public boolean isPrependHeaderHostname() {
		return prependHeaderHostname;
	}

	public void setPrependHeaderHostname(boolean prependHeaderHostname) {
		this.prependHeaderHostname = prependHeaderHostname;
	}

	public boolean isPrependHeaderAppName() {
		return prependHeaderAppName;
	}

	public void setPrependHeaderAppName(boolean prependHeaderAppName) {
		this.prependHeaderAppName = prependHeaderAppName;
	}
